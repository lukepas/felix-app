...
export default function Hero() {
    return (
        <section className="bg-[url('/src/assets/pictures/hero-pattern.jpg')] h-96 bg-cover bg-no-repeat">
            <div className="flex flex-col items-center content-center justify-center h-full before:content-[''] relative before:bg-black-rgba before:block before:absolute before:h-full before:w-full">
